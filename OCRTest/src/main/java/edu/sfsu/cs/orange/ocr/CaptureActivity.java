...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  private void initOcrEngine(File storageRoot, String languageCode, String languageName) {    
   ...
   // if (ocrEngineMode != TessBaseAPI.OEM_CUBE_ONLY) {
    ...
    if (ocrEngineModeName.equals("Both")) {
      indeterminateDialog.setMessage("Initializing Tesseract OCR engines for " + languageName + "...");
    } else {
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
   ...
   // sourceLanguageTextView.setText(sourceLanguageReadable);
    ...
    String store = ocrResult.getText();
    Intent intent = new Intent(CaptureActivity.this , MedicineDisp.class);
    intent.putExtra("MEDICINE", store);
